...
void main() {
  group('OBDCommand Flow Tests', () {
    test('Gear Position Command sequence and response', () async {
      ...
      expect(mockController.sentCommands,
          containsAllInOrder(['ATSH 797', 'ATFCSH 797', 'ATFCSM1', '03221156']));
    ...
    test('12V Battery Command sequence and response', () async {
      ...
      expect(mockController.sentCommands,
          containsAllInOrder(['ATSH 797', 'ATFCSH 797', 'ATFCSM1', '03221103']));
    ...
    test('Error response handling', () async {
      ...
      expect(mockController.sentCommands,
          containsAllInOrder(['ATSH 79B', 'ATFCSH 79B', 'ATFCSM1', '022101']));

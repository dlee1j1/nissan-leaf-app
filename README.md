...
- Track battery metrics while driving — collection starts automatically when the car powers on and the phone reconnects to the Leaf's Bluetooth, and stops when it disconnects

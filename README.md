...
- Track battery metrics while driving — collection starts automatically when the car powers on and the phone reconnects to the Leaf's Bluetooth, and stops on its own once the OBD dongle is out of range
